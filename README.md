...
To complete this exercises you will need to implement the stubbed out methods in [handler.go](https://github.com/alfredomagalhaes/gophercises_urlshort/blob/master/handler.go). There are a good bit of comments explaining what each method should do, and there is also a [main/main.go](https://github.com/alfredomagalhaes/gophercises_urlshort/blob/master/main/main.go) source file that uses the package to help you test your code and get an idea of what your program should be doing.
...
1. Update the [main/main.go](https://github.com/alfredomagalhaes/gophercises_urlshort/blob/master/main/main.go) source file to accept a YAML file as a flag and then load the YAML from a file rather than from a string.
